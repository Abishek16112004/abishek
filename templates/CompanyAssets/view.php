    ...
    <div class="column-responsive column-80">
        <div class="companyAssets view content">
            ...
            <table>
                <tr>
                    <th><?= __('User') ?></th>
                    <td><?= $companyAsset->has('user') ? $this->Html->link($companyAsset->user->name, ['controller' => 'Users', 'action' => 'view', $companyAsset->user->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Insurance Company') ?></th>
                    <td><?= $companyAsset->has('insurance_company') ? $this->Html->link($companyAsset->insurance_company->name, ['controller' => 'InsuranceCompanies', 'action' => 'view', $companyAsset->insurance_company->id]) : '' ?></td>
                </tr>
                <tr>
