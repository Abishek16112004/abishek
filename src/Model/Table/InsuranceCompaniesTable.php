 ...
 *
 * @property \App\Model\Table\CompanyAssetsTable&\Cake\ORM\Association\HasMany $CompanyAssets
 * @property \App\Model\Table\InsurancePoliciesTable&\Cake\ORM\Association\HasMany $InsurancePolicies
 *
...
class InsuranceCompaniesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->hasMany('InsurancePolicies', [
            'foreignKey' => 'insurance_company_id',
        ]);
    }
